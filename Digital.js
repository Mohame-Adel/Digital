...
window.onscroll=()=>
{
scrollProgress.style.width=`${(window.scrollY/(document.documentElement.scrollHeight-document.documentElement.clientHeight))*100}%`
...
document.querySelectorAll(`.${element.currentTarget.dataset.cat}`).forEach((ele)=>{
